...
export default function Footer() {
	...
	return (
		<>
			<div className="flex flex-col items-start gap-10 min-h-fit  w-full  justify-center bg-[#EAA53E75] py-20 px-4 md:px-7 lg:px-12">
				<div className="flex flex-col item-start md:flex-row justify-between gap-7 ">
