		...
		<>
			<div className="py-8 px-4 md:px-7 lg:px-12 flex justify-between">
				...
				<div className="hidden md:flex justify-center items-center gap-5 ">
					<span className="w-8 h-8 rounded-full bg-[#1E1E1A80]  flex justify-center items-center hover:bg-orange-500 cursor-pointer">
						<Icon
					...
					<span className="w-14 h-14 rounded-full bg-black-900  flex justify-center items-center hover:bg-orange-900 cursor-pointer">
						<Icon
